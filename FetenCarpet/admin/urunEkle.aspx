<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="urunEkle.aspx.cs" Inherits="FetenCarpet.admin.urunEkle" %>
            ...
            <div class="col-lg-6 mb-5">
                <div class="contact-form">
                    ...
                    <div class="control-group">
                            <asp:TextBox ID="TextBox5" class="form-control" runat="server" placeholder="Ürün Numarası"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Boş Geçilemez" ControlToValidate="TextBox5"></asp:RequiredFieldValidator><br />
                        </div> 
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <asp:TextBox ID="TextBox6" class="form-control" runat="server" placeholder="İndirimli Fiyat"></asp:TextBox><br />
                        </div>
                        <div class="control-group">
