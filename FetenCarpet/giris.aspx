<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris.aspx.cs" Inherits="FetenCarpet.giris" %>
                ...
                <%--<div class="mb-4">--%>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">                            
                            <asp:TextBox class="form-control"  placeholder="Kullanıcı Adı" ID="TextBox1" runat="server"></asp:TextBox>
                        ...
                        <div class="col-md-12 form-group">
                            <asp:Button class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-2" ID="Button1" runat="server" Text="Giriş Yap" OnClick="Button1_Click" />
                            <a href="kayitOl.aspx"><input id="Button2" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-2" type="button" value="Kayıt Ol" /></a>
                            <a href="index.aspx"><input id="Button3" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-2" type="button" value="Giriş Yapmadan Devam Et" /></a>
                        </div>
